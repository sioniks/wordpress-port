...
function portfolio_scripts() {
	...
	wp_enqueue_style( 'portfolio-style', get_template_directory_uri() . 'inc/css/main.css' );

	wp_enqueue_style( 'portfolio-style', get_template_directory_uri() . 'inc/css/media.css' );
 ...
 * Load TGM plugin.
 */
require get_template_directory() . '/tgm/portfolio.php';
